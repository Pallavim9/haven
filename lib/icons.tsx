...
// Haven logo icon components
interface HavenLogoIconProps {
  size?: "sm" | "md" | "lg";
  showAnimation?: boolean;
}

export function HavenLogoIcon({ size = "md", showAnimation = true }: HavenLogoIconProps) {
  const sizeClasses = {
    sm: "w-12 h-12",
    md: "w-24 h-24",
    lg: "w-32 h-32",
